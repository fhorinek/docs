...
Before reading this section, please read the [Button](/widget/btn) section for better understanding.
...
The image sources works the same as described in the [Image object](/widget/img) except that, "Symbols" are not supported by the Image button.

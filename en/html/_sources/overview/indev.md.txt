...
For example, if a [Text area](/widget/textarea) is focused and you press some letter on a keyboard, the keys will be sent and inserted into the text area.
Similarly, if a [Slider](/widget/slider) is focused and you press the left or right arrows, the slider's value will be changed.
...
- **LV_KEY_ESC**  Close or exit (E.g. close a [Drop down list](/widget/dropdown))
- **LV_KEY_DEL**  Delete (E.g. a character on the right in a [Text area](/widget/textarea))
- **LV_KEY_BACKSPACE** Delete a character on the left (E.g. in a [Text area](/widget/textarea))
- **LV_KEY_HOME** Go to the beginning/top (E.g. in a [Text area](/widget/textarea))
- **LV_KEY_END** Go to the end (E.g. in a [Text area](/widget/textarea)))
...
Usually, an object which can not be pressed (like a [Slider](/widget/slider)) leaves *Edit* mode on short click. But with object where short click has meaning (e.g. [Button](/widget/btn)), long press is required.
